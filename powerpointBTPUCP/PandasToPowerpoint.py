...
def df_to_table(slide, df, left, top, width, height, colnames=None, col_formatters=None, rounding=None,rowname=None):
    ...
    for example: resizing columns, changing formattting etc.
    ...
    if rownames is not None:
        for row_index,row_name in enumerate(rownames):
            res.table.cell(row_index,0).text = rowname
